...
# total number of days that shortMA > longMA  cause a rise within the test range
...
# total number of days that shortMA > longMA within the test range
...
# average continue rise days that shortMA > longMA within the test range
...
# average continue rise percentage that shortMA > longMA within the test range
